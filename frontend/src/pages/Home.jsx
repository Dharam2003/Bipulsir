  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.85), rgba(20, 20, 20, 0.85)), url('https://images.unsplash.com/photo-1659355894058-c02512c16533?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NzB8MHwxfHNlYXJjaHwyfHxlZHVjYXRpb24lMjBjb2FjaGluZ3xlbnwwfHx8Ymx1ZXwxNzU4MDQ0NjY4fDA&ixlib=rb-4.1.0&q=85')`,
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-in fade-in slide-in-from-bottom duration-1000">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              Master Your
              <span className="text-gray-300 block mt-2">Government Exams</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link 
                to="/courses"
                className="bg-gradient-to-r from-white to-gray-100 hover:from-gray-100 hover:to-gray-200 text-black px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 min-w-[200px]"
              >
                Explore Courses
              </Link>
              <Link 
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 hidden lg:flex space-x-8 text-white/80">
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-300">1000+</div>
            <div className="text-sm">Students</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-300">95%</div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Expert Faculty */}
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 hover:border-black transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-black mb-4">Expert Faculty</h3>
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 hover:border-black transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-black mb-4">Study Materials</h3>
              <p className="text-gray-600 leading-relaxed">
